 ...
 */
	public static function toReadableSize($size) {
		switch (true) {
			case $size < 1024:
				return __dn('framework', '%d Byte', '%d Bytes', $size, $size);
			case round($size / 1024) < 1024:
				return __d('framework', '%s KB', self::precision($size / 1024, 0));
			case round($size / 1024 / 1024, 2) < 1024:
				return __d('framework', '%s MB', self::precision($size / 1024 / 1024, 2));
			case round($size / 1024 / 1024 / 1024, 2) < 1024:
				return __d('framework', '%s GB', self::precision($size / 1024 / 1024 / 1024, 2));
			default:
				return __d('framework', '%s TB', self::precision($size / 1024 / 1024 / 1024 / 1024, 2));
		}
	}
